...
export const traceabilityMatrix: TraceItem[] = [
  ...
  { ref: "BRS1–10", requirement: "Feeder balancing hierarchy & loss calculation engine", scoringArea: "Functional", module: "Configure / Calculate", tab: "calculate", status: "demonstrated" },
  { ref: "RQ5", requirement: "Customer-network linking (CNL) validation", scoringArea: "Functional", module: "Data Validation", tab: "validation", status: "demonstrated" },
  { ref: "RQ7", requirement: "Business-rule data validation", scoringArea: "Functional", module: "Data Validation", tab: "validation", status: "demonstrated" },
  { ref: "RQ8", requirement: "Feeders with no energy delivered exception", scoringArea: "Functional", module: "Data Validation", tab: "validation", status: "demonstrated" },
  { ref: "RQ10", requirement: "Exception routing to role-players", scoringArea: "Functional", module: "Data Validation", tab: "validation", status: "demonstrated" },
  { ref: "BRS16", requirement: "Log work request to maintenance system", scoringArea: "Functional", module: "Work Orders", tab: "workorders", status: "demonstrated" },
  { ref: "BRS17", requirement: "Initiate audit on worst-performing network", scoringArea: "Functional", module: "Work Orders", tab: "workorders", status: "demonstrated" },
